...
router.post("/api/addtosubs", syncHandler((req, res) => {
...
router.post("/api/removefromsubs", syncHandler((req, res) => {
    const user_chl_id = req.body.user_chl_id;
    const channel_id = req.body.channel_id;
...
router.get("/api/issub", syncHandler((req, res) => {
...
router.get("/api/get-subs", syncHandler((req, res) => {
